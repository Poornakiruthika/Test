...
'Create Attributions in CONTENT': function ( client ) {
  ...
  pause(9000).
            ...
            getText ( '.content-count > strong', function ( actualCountResult ) {
              if ( actualCountResult.status !== -1 ) {
                ...
                console.log( 'Count - After adding an Attributions: ' + actualCount );
                expectedCount = ( ( +currentCount ) + ( +1 ) );
                console.log ( 'Count - incemented by 1 in Attributions: ' + expectedCount );               
              ...
              client.getText ( '.content-count > strong', function ( currentCountResult ) {
                if ( currentCountResult.status !== -1 ) {
                  currentCount = currentCountResult.value;
                  currentCount = currentCount.substring ( 1, currentCount.length - 1 );
                  console.log ( 'Count - New Attributions : ' + currentCount )
                }
