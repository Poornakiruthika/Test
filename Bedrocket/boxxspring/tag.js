...
var worksheet = workbook.Sheets [ 'categories_tag' ];
var categoryTitle = [ ];
...
'Create TAG in Categories': function ( client ) {
...
useCss().
            ...
            pause(9000).
           waitForElementVisible ( ".dropdown-submenu > li:nth-child(1) > a:nth-child(1)", 9000,false ).
            ...
            click ( ".dropdown-submenu > li:nth-child(1) > a:nth-child(1)" ).
                pause(9000)          
            ...
            getText ( '.content-count > strong', function ( actualCountResult ) {
              if ( actualCountResult.status !== -1 ) {
                ...
                if ( actualCount == expectedCount ) {
                  ...
                  client.writeToExcelPass ( 'boxxspring.xlsx', 'categories_tag', ++j, 9,10 );
                  console.log ( "j after value:", j );
                }
                else {
                  console.log ( "if Failed" );
                  client.writeToExcelFail ( 'boxxspring.xlsx', 'categories_tag', ++j, 9,10, actualCount, expectedCount );
                }
