...
var worksheet = workbook.Sheets [ 'categories_playlist' ];
var categoryTitle = [ ];
...
'Create Categories-Playlist in CONTENT': function ( client ) {
            ...
            getText ( '.content-count > strong', function ( actualCountResult ) {
              if ( actualCountResult.status !== -1 ) {
                ...
                if ( actualCount == expectedCount ) {
                  ...
                  client.writeToExcelPass ( 'boxxspring.xlsx', 'categories_playlist', ++j, 9,10 );
                  console.log ( "j after value:", j );
                }
                else {
                  console.log ( "if Failed" );
                  client.writeToExcelFail ( 'boxxspring.xlsx', 'categories_playlist', ++j, 9,10, actualCount, expectedCount );
                }
