...
'Create Categories-Group in CONTENT': function ( client ) {
...
useCss().
            ...
            pause(9000).
           waitForElementVisible ( ".dropdown-submenu > li:nth-child(2) > a:nth-child(1)", 9000,false ).
            //waitForElementVisible ( "(//div[@class='hover-dropdown'])//*[ text() = 'Tag']", 9000,false ).
                        pause(9000).
                         ...
                         // useXpath().
                          ...
                          //click("//ul[@class='dropdown-submenu']//a[contains(.,'Tag')]").                          useCss().
            click ( ".dropdown-submenu > li:nth-child(2) > a:nth-child(1)" ).
                pause(9000)          
            ...
            getText ( '.content-count > strong', function ( actualCountResult ) {
              if ( actualCountResult.status !== -1 ) {
                ...
                if ( actualCount == expectedCount ) {
                  ...
                  client.writeToExcelPass ( 'boxxspring.xlsx', 'categories_group', ++j, 9,10 );
                  console.log ( "j after value:", j );
                }
                else {
                  console.log ( "if Failed" );
                  client.writeToExcelFail ( 'boxxspring.xlsx', 'categories_group', ++j, 9,10, actualCount, expectedCount );
                }
