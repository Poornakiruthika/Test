          ...
          if ( urlData == "autoplay=true" || urlData == "autoplay=1" ) {
            ...
            getText ( '.unimatrix-video-current-time-display > span', function ( currenttime ) {
              ...
              if ( autoplay_time > '00:00' ) {
                ...
                this.verify.fail ( autoplay_time, 'Current time should be greater then "00:00" ', 'Autoplay functionality is not working' );
                autoplay.writeToExcelFail ( 'videoplayer.xlsx', 'Autoplay', ++excelRow, 2, 3, "ActualResult: '" + autoplay_time +
